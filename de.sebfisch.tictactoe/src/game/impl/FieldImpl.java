...
public class FieldImpl extends MinimalEObjectImpl.Container implements Field {
	 ...
	 * @ordered
	 */
	protected static final Player MARK_EDEFAULT = Player.X;
	 ...
	 * @ordered
	 */
	protected Player mark = MARK_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setMark(Player newMark) {
		Player oldMark = mark;
		mark = newMark == null ? MARK_EDEFAULT : newMark;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.FIELD__MARK, oldMark, mark));
	}
