...
public class GameFactoryImpl extends EFactoryImpl implements GameFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case GamePackage.PLAYER:
				return createPlayerFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case GamePackage.PLAYER:
				return convertPlayerToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Player createPlayerFromString(EDataType eDataType, String initialValue) {
		Player result = Player.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertPlayerToString(EDataType eDataType, Object instanceValue) {
